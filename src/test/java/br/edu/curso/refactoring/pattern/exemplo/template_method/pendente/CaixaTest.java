...
/**
 * <li>Caixa eletr�nico que efetua pagamento de documentos <br/>
 * <li> Os documentos podem ser boleto e por transfer�ncia <br/>
 * <li> Apesar de existir tipos de documento diferentes eles realizam 
 * a��es similares e outras espec�ficas  
 * <br/><br/>
 * 
 * A id�ia aqui � exercitar sobre como reusar as asser��es para simplificar o teste
 */
